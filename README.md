...
Endring av situasjon for arbeidssøker

## Dokumentasjon

https://arbeidssoker.situasjon.intern.dev.nav.no/docs
...
```sh
$ curl localhost:8080/api/v1/situasjon -H 'Authorization: Bearer <access_token>'
```
...
docker exec -it paw-arbeidssoker-situasjon_kafka_1 /usr/bin/kafka-console-producer --broker-list 127.0.0.1:9092 --topic arbeidssoker-registrert-v2
```

### Consumer

Consumer meldinger fra `arbeidssoker-situasjon-v1`

```sh
docker exec -it paw-arbeidssoker-situasjon_kafka_1 /usr/bin/kafka-console-consumer --bootstrap-server 127.0.0.1:9092 --topic arbeidssoker-situasjon-v2
```
